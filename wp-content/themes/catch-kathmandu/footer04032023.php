	...
	<footer id="colophon" role="contentinfo">
		...
		get_sidebar( 'footer' );
                ...
                echo '<div style="width: 100%;padding-left: 20px; padding-top: 20px; padding-bottom: 20px;">
                        ...
                        <tr>
                            <td style="width:220px; padding-right: 1px;"><a class="twitter-timeline" data-lang="es" data-width="220" data-height="450" href="https://twitter.com/rvaraguayan?ref_src=twsrc%5Etfw">Tweets por rvaraguayan</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></td>
                            <td style="width:220px; padding-right: 20px;"><a class="twitter-timeline" data-lang="es" data-width="220" data-height="450" href="https://twitter.com/TransporteGobVe?ref_src=twsrc%5Etfw">Tweets por TransporteGobVe</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></td>
                            <td style="width:220px; padding-right: 20px;"><a class="twitter-timeline" data-lang="es" data-width="220" data-height="450" href="https://twitter.com/FonturOficialve?ref_src=twsrc%5Etfw">Tweets por FonturOficialve</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></td>
                            <td style="width:220px; padding-right: 20px;"><a class="twitter-timeline" data-lang="es" data-width="220" data-height="450" href="https://twitter.com/ELOYSULBARAN?ref_src=twsrc%5Etfw">Tweets por ELOYSULBARAN</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></td>
                            <td style="width:220px; padding-right: 20px;"><a class="twitter-timeline" data-lang="es" data-width="220" data-height="450" href="https://twitter.com/T_TicketVzla?ref_src=twsrc%5Etfw" >Tweets por T_TicketVzla</a><script async="" src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></td>
                        </tr>
                        </table>
                   </div>';
                /**************************************************************************************************/
