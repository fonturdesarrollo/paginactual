...
final class catch_kathmandu_upgrade_pro_customize {
	...
	public function enqueue_control_scripts() {
		wp_enqueue_script( 'catch-kathmandu-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/panel/customizer/upgrade-button/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'catch-kathmandu-upgrade-button-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/panel/customizer/upgrade-button/customize-controls.css' );
	}
}
