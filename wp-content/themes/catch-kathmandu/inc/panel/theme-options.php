...
function catchkathmandu_make_footer_modifications() {
	global $catchkathmandu_options_settings;
    /************Código del footer original del tema*********************/
    ...
    /*********************************************************************/
    /*******Se modifica código del footer para incluir la dirección de Fontur y los créditos del sitio  17/05/2017 YG******/
    /************************************************************************************************/
    /*$new_footer_code = '<div class="copyright" style="font-weight:bold;">' .'<span>FUNDACIÓN FONDO NACIONAL DE TRANSPORTE URBANO<br>
      Av. Los Jabillos, entre Av. Libertador y calle Las Flores. Edf. FONTUR. Sabana Grande.Caracas.<br>
      Máster: (0212) 707.02.11 - e-mail:fontur@fontur.gob.ve - http://www.fontur.gob.ve RIF: G-20006289-4 <span><br><br>'. '</div>'.'<div class="powered" style="font-weight:bold;"><span>Desarrollado por la Oficina de Tecnología de la Información y la Comunicación y Diseñado por la Oficina de Gestión Comunicacional de Fontur.<br>Se recomienda el uso de los navegadores<a href="https://www.mozilla.org/es-ES/firefox/new/" target="_blank"><img src="wp-content/uploads/navegadores/mozilla.png" title="Mozilla Firefox" width="25px" height="25px"></a><a href="https://www.google.com.ve/chrome/browser/desktop/" target="_blank"><img src="wp-content/uploads/navegadores/chrome.png" title="Google Chrome" width="25px" height="25px"></a><span>'.'</div>';
    /************************fin codigo modificado 17/05/2017***************************************/
    /**************************SE CAMBIA EL PIE DE PAGINA PARA SUSTITUIR TEXTO DE DIRECCION POR UNA IMAGEN**********************/
    $new_footer_code = '&nbsp';
    /**************************************************************************************************/
