...
function catchkathmandu_category_sliders() {
	...
	echo $catchkathmandu_category_sliders;
        echo '<div class="separador-titulo" style="line-height: 55px;font-size:25px;"><h3><span>&nbsp;&nbsp;ENLACES MÚLTIPLES</span></h3></div>';/**SE INCLUYE SEPARADOR ENLACES MULTIPLES 10/06/2002 YG*/
} // catchkathmandu_category_sliders
endif;
...
function catchkathmandu_homepage_featured_content() {
	...
	if ( $disable_homepage_featured == "0" ) {
		...
		echo $output;
                echo '<div class="separador-titulo" style="line-height: 55px;font-size:25px;"><h3><span>&nbsp;&nbsp;</span></h3></div>';
	}
