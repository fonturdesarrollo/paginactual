...
function wp_html5video_setup_post_types() {
	...
	$html5video_labels =  apply_filters( 'sp_html5video_labels', array(
		...
		'featured_image'		=> __( 'Videos Gallery Image', 'html5-videogallery-plus-player' ),
		'set_featured_image'	=> __( 'Set Videos Gallery Image', 'html5-videogallery-plus-player' ),
		'remove_featured_image'	=> __( 'Remove Videos Gallery image', 'html5-videogallery-plus-player' ),
		'use_featured_image'	=> __( 'Use as Videos Gallery image', 'html5-videogallery-plus-player' ),
	) );
