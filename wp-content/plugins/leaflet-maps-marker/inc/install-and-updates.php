...
if (version_compare(get_option('leafletmapsmarker_version'),'3.12.8','=')) {
	$version_before_update = get_transient( 'leafletmapsmarker_version_before_update' );
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_before_update', 'MapsMarker-transient-for-dynamic-changelog', 60 );
		update_option('leafletmapsmarker_version_before_update', '3.12.8'); //2do - update to version before update
	}
	update_option('leafletmapsmarker_version', '3.12.9');
}
if (version_compare(get_option('leafletmapsmarker_version'),'3.12.9','=')) {
	...
	if ( $version_before_update === FALSE ) {
		set_transient( 'leafletmapsmarker_version_before_update', 'MapsMarker-transient-for-dynamic-changelog', 60 );
		update_option('leafletmapsmarker_version_before_update', '3.12.9');
	}
	update_option('leafletmapsmarker_version', '3.12.10');
