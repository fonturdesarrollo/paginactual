...
echo '<p><div class="updated" style="padding:10px;margin:10px 0;clear:both;"><h3 style="margin:10px 0;">Important notice</h3>' . __('Leaflet Maps Marker has earned its retirement - existing users get a parting gift: a coupon code for an unexpiring Maps Marker Pro license (<a href="https://demo.mapsmarker.com" target="_blank">view demo</a>). For a limited time only, get yours now!</a><p><strong><a href="https://www.mapsmarker.com/v3.12.10" target="_blank">Read more & get your coupon code</a></strong>') . '</div></p>';
